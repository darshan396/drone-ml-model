...
from torch.cuda.amp import GradScaler, autocast # <--- SPEED BOOST
import glob
import os
import numpy as np
...
EPOCHS = 30            # 10k images * 10 epochs is plenty
NUM_WORKERS = 4        # Load data in parallel
IMAGE_DIR = "../data/dataset/unlabeled_images" # Put your 10k images here

# ---------------- DATASET ----------------
class BigUnlabeledDataset(Dataset):
    def __init__(self, image_dir):
        # Efficiently find all images
    ...
    def __getitem__(self, idx):
        ...
        if data is None: # Skip corrupt files
...
def pretrain_large():
    # 1. Setup
    torch.backends.cudnn.benchmark = True # Optimizes for your specific GPU
